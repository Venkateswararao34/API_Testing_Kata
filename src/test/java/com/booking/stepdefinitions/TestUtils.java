...
public class TestUtils {
	...
	public CreateBookingRequestPayload generateCreateBookingRequest(Map<String, String> row, int randomId) {
		return new CreateBookingRequestPayload(
				randomId, 
				randomId,
				Boolean.parseBoolean(getOptionalStringValue(row, "depositpaid")),
				getOptionalStringValue(row, "firstname"), 
				getOptionalStringValue(row, "lastname"),
				getOptionalStringValue(row, "email"), 
				getOptionalStringValue(row, "phone"),
				getOptionalStringValue(row, "checkin"), 
				getOptionalStringValue(row, "checkout"));
	}
